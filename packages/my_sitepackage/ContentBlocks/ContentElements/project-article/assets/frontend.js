document.addEventListener("DOMContentLoaded", () => {
    // Scoped per article — supports multiple project-article elements on one page
    document.querySelectorAll(".cb-project-article").forEach((articleEl) => {
        const articleBody = articleEl.querySelector(".cb-project-article-body");
        ...
        headings.forEach((heading, index) => {
            const id = heading.id || `project-heading-${index}`;
            heading.id = id;
